...
def main():
    samples, y_labels = ct.LoopsThroughAllVids("../VideoWaterDatabase/videos/water/",
                                               "../VideoWaterDatabase/masks/water/",
                                               "../VideoWaterDatabase/videos/non_water/", 400  , 2, 0, 4, 200,
                                               3500, 10, 74)
...
#    y_labels = np.load("saved_ylabels_deriv200.npy")
    ...
    y_labels = y_labels[:,0]
    print(samples.shape) # 910000 * 456
    print(y_labels.shape)# 910000 * 1
