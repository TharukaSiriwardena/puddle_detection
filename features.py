...
def fourierTransform(completeVid,randx,randy,randz,boxSize,temporalLength):
    ...
    fourier = np.fft.fft(arrforFourier)#Compute the one-dimensional discrete Fourier Transform.
